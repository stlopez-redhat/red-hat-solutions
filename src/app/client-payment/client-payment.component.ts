...
export class ClientPaymentComponent implements OnInit {
  ...
  selectedDebtAccount = new ObAccountsData;
  selectedPayee = BankingAccountInfo;
  accountBalance = '';
  payAmount: number | undefined;
  newBalance: number | undefined;
  paymentType: string | undefined;
  recurringPayment: string | undefined;
  accountInfo = new Array<BankingAccountInfo>();
  accounts = new Array<BankingAccountInfo>();
  payees = new Array<BankingAccountInfo>();
  obAccounts = new Array<ObAccountsData>();
  ...
  public udpateAccountData() {
    ...
    this.selectedPayee = BankingAccountInfo;
  }
  ...
  getBalance($event: { source: { value: ObAccountsData; }; }) {
    this.selectedDebtAccount = $event.source.value;
